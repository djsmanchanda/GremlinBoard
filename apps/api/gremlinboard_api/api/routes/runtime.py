...
async def runtime_status(
    ...
    return RuntimeStatusRead(
        ...
        replay_miss_reasons=event_stats.replay_miss_reasons,
        ...
        stale_subscriber_count=event_stats.stale_subscriber_count,
        pruned_subscriber_count=event_stats.pruned_subscriber_count,
